<?php
    ...
    function validarRucPersonaNatural($numero = '')
    {
        ...
        try {
             ...
             validarCodigoEstablecimiento(substr($numero, 10, 3));
             algoritmoModulo10(substr($numero, 0, 9), $numero[9]);
        } catch (Exception $e) {
             setError($e->getMessage());
            return false;
    ...
    function validarRucSociedadPrivada($numero = '')
    {
        ...
        try {
             ...
             validarCodigoEstablecimiento(substr($numero, 10, 3));
             algoritmoModulo11(substr($numero, 0, 9), $numero[9], 'ruc_privada');
        } catch (Exception $e) {
             setError($e->getMessage());
            return false;
        }
    ...
    function validarRucSociedadPublica($numero = '')
    {
        ...
        try {
             ...
             validarCodigoEstablecimiento(substr($numero, 9, 4));
             algoritmoModulo11(substr($numero, 0, 8), $numero[8], 'ruc_publica');
        } catch (Exception $e) {
             setError($e->getMessage());
            return false;
        }
