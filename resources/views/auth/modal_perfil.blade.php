        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row ">
                                ...
                                <div class="row_">
                                    <div class="col-md-6">
                                        <ul class="nav nav-pills nav-stacked"style="margin-left:0px">
                                            <li style="border-color: white"><a><i class="fa fa-credit-card text-blue"></i> <b class="text-black" style="font-weight: 650 !important">Identificación</b>: <span  id="iden"> {{ Auth::user()->persona->cedula }} </span></a></li>
                                           
                                        </ul>
                                        <ul class="nav nav-pills nav-stacked"style="margin-left:0px">
                                            <li style="border-color: white"><a><i class="fa fa-phone text-blue"></i> <b class="text-black" style="font-weight: 650 !important"> Teléfono</b>: <span  id="tele">{{ Auth::user()->persona->telefono }}</span></a></li>
                                           
                                        </ul>
                                    </div>     
                                    <div class="col-md-6">
                                        <ul class="nav nav-pills nav-stacked" style="margin-left:12px">
                                            <li style="border-color: white"><a><i class="fa fa-user text-blue"></i> <b class="text-black" style="font-weight: 650 !important">Usuario:</b> <span  id="user"> {{ Auth::user()->persona->nombres }}  {{ Auth::user()->persona->apellidos }}</span></a></li>
                                            
                                        </ul>
                                        <ul class="nav nav-pills nav-stacked" style="margin-left:12px">
                                            <li style="border-color: white"><a><i class="fa fa-key text-blue"></i> <b class="text-black" style="font-weight: 650 !important">Perfil:</b> <span  id="perf"> {{ auth()->user()->perfil->nombre_perfil->descripcion}}  </span></a></li>
                    ...
                    <div id="form_cambio_contra" style="display: none">
