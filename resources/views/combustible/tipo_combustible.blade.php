...
@section('content')
    ...
    <section class="content" id="content_form">
        ...
        <div class="box" id="listado_combustible">
            ...
            <div class="box-body">
                ...
                <div class="table-responsive">
                    <table id="tabla_combustible" width="100%"class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Descripción</th>
        ...
        <div id="form_ing" style="display:none">
            <form class="form-horizontal" id="form_combustible" autocomplete="off" method="post"
                action="">
                {{ csrf_field() }}
                <div class="box">
                    <div class="box-header with-border">
